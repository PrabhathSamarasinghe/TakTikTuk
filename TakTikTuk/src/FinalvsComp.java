...
public class FinalvsComp implements ActionListener{
    ...
    JLabel label3 = new JLabel("You Lost :");
    ...
    FinalvsComp(int TotalGames, int PlayerOneWins, int PlayerTwoWins, int Drawn){
        songs.End();
